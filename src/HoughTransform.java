...
public class HoughTransform {
	 ...
	 public void hough() throws IOException{
	        ...
	        File src = new File("./image/line1.png");
	        ...
	        ArrayList<Hough> index = maxIndex(hist,90); //找到大于最大值*0.7的二维直方图的点
	        ...
	        for(int k =0;k<index.size();k++){
	          ...
	          writeImage("./image/line_2.png", data, w, h);
	    ...
	    private ArrayList<Hough> maxIndex(int[][] hist, int i) {
	        ArrayList<Hough> in = new ArrayList<Hough>();
	        int max = 0;
